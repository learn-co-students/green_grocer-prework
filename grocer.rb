...
def consolidate_cart(cart)
  ...
  cart.each do |food_item_hash|
    ...
    food_item_hash.each do |food_item_key, attribute_hash|
      ...
      binding.pry # after three exits, food_item_hash properly returns {"AVOCADO"=>{:price=>3.0, :clearance=>true, :count=>2}} .  The count properly registers as 2 .  And, of course, attribute_hash properly returns {:price=>3.0, :clearance=>true, :count=>2}   .
